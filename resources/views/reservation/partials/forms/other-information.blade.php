<fieldset>
    ...
    <div class="form-group required">
        ...
        <div class="col-sm-2 col-xs-12">
            <input name="adult" class="form-control" type="number" id="ReservationAdult" required="required"/>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2 col-xs-12">
            <input name="child" class="form-control" type="number" id="ReservationChild"/>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6 col-xs-12">
            <textarea name="message" class="form-control"
                      ...
                      cols="30" rows="6" id="ReservationMessage"></textarea>
        </div>
    </div>
</fieldset>
